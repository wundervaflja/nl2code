...
def parse_django_dataset_nt_only():
    ...
    dev_annot_file = 'dataset/en-django/dev.anno'
...
def check_terminals():
    ...
    grammar, parse_trees = parse_django('dataset/en-django/all.code')
    annot_file = 'dataset/en-django/all.anno'
...
def query_to_data(query, annot_vocab):
    ...
    token_num = min(70, len(query_tokens))
...
if __name__== '__main__':
    ...
    # for i, query in enumerate(open('dataset/en-django/all.anno')):
